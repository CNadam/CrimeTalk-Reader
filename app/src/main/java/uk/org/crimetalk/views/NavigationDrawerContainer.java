 ...
 */
public class NavigationDrawerContainer extends FrameLayout {
    ...
    public NavigationDrawerContainer(Context context) {
        super(context);
        init(context, null, 0);
    }

    public NavigationDrawerContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public NavigationDrawerContainer(
